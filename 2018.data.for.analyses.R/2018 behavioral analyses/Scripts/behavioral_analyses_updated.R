...
# raw data (i.e. unadjusted plots) are fine, will go with that for the plot of proportion of time exposed
...
# doing model selection a better way
...
# plot with adjusted means (use this one when it comes time to put all plots together)
...
fr.a <-lmer(bites.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) + (Year*avg.inhab) + (Treatment*Year*avg.inhab) +
                   (1|Trial), REML=F, data = behave)
Anova(fr.a, type = "III")
...
# Response: bites.min
# Chisq Df Pr(>Chisq)  
# (Intercept)              0.8354  1    0.36071  
# Treatment                2.2226  2    0.32912  
# Year                     2.6817  1    0.10151  
# avg.inhab                0.4950  1    0.48170  
# Treatment:Year           0.2022  2    0.90384  
# Treatment:avg.inhab      1.8931  2    0.38809  
# Year:avg.inhab           2.7878  1    0.09498 .
# Treatment:Year:avg.inhab 0.0627  2    0.96914  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# removing 3-way

fr.b <-lmer(bites.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) + (Year*avg.inhab) +
              (1|Trial), REML=F, data = behave)
Anova(fr.b, type = "III")
...
# Response: bites.min
# Chisq Df Pr(>Chisq)  
# (Intercept)         0.8633  1    0.35281  
# Treatment           2.3474  2    0.30922  
# Year                3.0301  1    0.08173 .
# avg.inhab           0.5051  1    0.47727  
# Treatment:Year      2.8502  2    0.24048  
# Treatment:avg.inhab 2.0555  2    0.35781  
# Year:avg.inhab      3.1607  1    0.07543 .
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# rem year*inhab (fit is singular...)

fr.c <-lmer(bites.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) +
              (1|Trial), REML=F, data = behave)
summary(fr.c)
Anova(fr.c, type = "III")
...
# Response: bites.min
# Chisq Df Pr(>Chisq)  
# (Intercept)         3.2875  1    0.06981 .
# Treatment           2.7186  2    0.25685  
# Year                0.0001  1    0.99121  
# avg.inhab           0.0111  1    0.91623  
# Treatment:Year      3.3265  2    0.18952  
# Treatment:avg.inhab 2.3603  2    0.30723  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# seems like trial doesn't explain that much of the variation, so going to run as regular (i.e. non-mixed) ANCOVA instead, mention this in the methods

# running model instead as fixed ANCOVA
...
# Response: courtship.min
# Chisq Df Pr(>Chisq)   
# (Intercept) 7.3825  1   0.006586 **
#   Treatment   4.1292  2   0.126872   
# Year        0.8976  1   0.343430   
# avg.inhab   1.5992  1   0.206023   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
# rerunning this, including trial, going to see if model fit is singular

# full model

mr.a <-lmer(movements.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) + (Year*avg.inhab) + (Treatment*Year*avg.inhab) +
              (1|Trial), REML=F, data = behave)
Anova(mr.a, type = "III")
...
# Chisq Df Pr(>Chisq)  
# (Intercept)              3.4065  1    0.06494 .
# Treatment                0.0365  2    0.98193  
# Year                     1.3756  1    0.24085  
# avg.inhab                0.7485  1    0.38697  
# Treatment:Year           0.3817  2    0.82624  
# Treatment:avg.inhab      0.0108  2    0.99461  
# Year:avg.inhab           1.2187  1    0.26962  
# Treatment:Year:avg.inhab 0.3355  2    0.84555  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# remove 3-way

mr.a1 <-lmer(movements.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) + (Year*avg.inhab) +
               (1|Trial), REML=F, data = behave)
Anova(mr.a1, type = "III")
...
# Response: movements.min
# Chisq Df Pr(>Chisq)  
# (Intercept)         3.9703  1    0.04631 *
#   Treatment           0.1416  2    0.93164  
# Year                1.1583  1    0.28182  
# avg.inhab           0.5780  1    0.44709  
# Treatment:Year      0.4194  2    0.81084  
# Treatment:avg.inhab 0.0256  2    0.98730  
# Year:avg.inhab      0.9976  1    0.31790  
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

# remove year*avg.inhab (fit is singular), run as fixed ANCOVA from here on

mr.a2 <-lmer(movements.min ~ Treatment + Year + avg.inhab + (Treatment*Year) + (Treatment*avg.inhab) +
               (1|Trial), REML=F, data = behave)
summary(mr.a2)
Anova(mr.a2, type = "III")
...
mr.a3 <-lmer(movements.min ~ Treatment + Year + avg.inhab + (Treatment*Year) +
               (1|Trial), REML=F, data = behave)
Anova(mr.a3, type = "III")
...
mr.a4 <-lmer(movements.min ~ Treatment + Year + avg.inhab +
               (1|Trial), REML=F, data = behave)
Anova(mr.a4, type = "III")
...
emmeans(mr.a4, pairwise~Treatment)
...
mr.a4.emm <- emmeans(mr.a4, ~ Treatment)
plot(mr.a4.emm)

# rerun as fixed ANCOVA from here down ####
